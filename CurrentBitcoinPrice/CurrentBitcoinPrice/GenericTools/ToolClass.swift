...
public class ToolClass: NSObject {
    ...
    /// 获取版本号
    @objc static func getAppVersionNumString() -> String {
    ...
    @objc static func nameOfClass(_ Class: AnyClass) -> String {
    ...
    /*
    @objc static func getTopBottomPaddingArray() -> [CGFloat] {
    ...
    */
    ...
    /// 获取当前页面的最顶层控制器
    /*
    @objc static func currentVisibleViewController() -> UIViewController {
    ...
    */
    ...
    static private func getVisibleViewControllerFrom(vc: UIViewController) -> UIViewController {
    ...
    /// 清理TmpDirectory
    @objc static func clearTmpDirectory() {
    ...
    /// 清理DocumentDirectory
    @objc static func clearDirectory(_ searchPath: FileManager.SearchPathDirectory, folderName: String?) {
        let fileManager = FileManager.default
        var directoryPath = ""
...
public class DelayTask: NSObject {
    ...
    @objc static func createTaskWith(Id: String, taskClosure: @escaping ()->(), queue: DispatchQueue, delayTime: TimeInterval) -> Void {
